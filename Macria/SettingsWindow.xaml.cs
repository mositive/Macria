    ...
    public partial class SettingsWindow : Window
    {
        ...
        private async void btnOgret_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    txtKonum.Text = "CATIA'da paneli açın, fareyi Save As butonunun " +
                                    "üzerine getirin ve F8'e basın.  (" + kalan + " sn)";
                ...
                txtKonum.Text = "Süre doldu, F8'e basılmadı.  " + DurumMetni();
                sonucYazildi = true;
            }
            ...
            finally
            {
                ...
                btnOgret.Content = "Konumu Öğret";
                Topmost = false;

                if (!sonucYazildi) KonumYaz();
            }
        }
